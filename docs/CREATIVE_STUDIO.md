...
Measured across both gates' corpora — 7,614 generated rows in twenty shapes, sixteen hand-written multi-line messages, and a repeated-mention set: **no row carries a misleading token** (296 on main), a name is readable in 1,582 rows against 6,769 on main, and a property sweep over 3,535 reported names finds none of them surviving anywhere in the stored row.

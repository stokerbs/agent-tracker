-- 0084_user_pins.sql  (renumbered from 0083 — 0083 was taken by
-- 0083_atomic_claim_approval, authored in parallel; this object was already
-- applied to prod under the old number, hence the idempotent guards below.)
